...
await upsert({
  ...
  partnershipEmail: "partnerships@zithelorealestate.com",
...
const teamMembers = [
  {
    ...
    bio: "Dr. Oluwaseun Akinbobola is a healthcare entrepreneur, business strategist, and investor with a proven track record of building and scaling multi-sector businesses across healthcare, real estate, and consumer markets. As Chairman, he provides strategic direction and governance oversight, ensuring the Group\u2019s growth is anchored in disciplined execution, structured expansion, and long-term value creation. He is the Co-Founder of Beaconhill Smile Group and leads Zithelo Homes USA, a property acquisition and management company based in Atlanta. He has completed executive education at The Wharton School, University of Pennsylvania, USA, and Strathmore Business School, Kenya, and is an alumnus of the Owner-Manager Programme at Lagos Business School.",
    credentials: ["Executive Education \u2014 The Wharton School, University of Pennsylvania, USA", "Executive Education \u2014 Strathmore Business School, Kenya", "Lagos Business School \u2014 Owner-Manager Programme", "Co-Founder, Beaconhill Smile Group", "Founder, Zithelo Homes USA (Atlanta)"],
    featured: true,
    order: 1,
  },
  {
